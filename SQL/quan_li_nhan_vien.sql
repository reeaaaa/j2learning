Creat database Quan_li_nhan_vien
...
join phong_ban
on phong_ban.ma = nhan_vien.phong_ban
--------------------------------------------------------------------------------HIỂN THỊ TÊN CHỨC VỤ CỦA NHÂN VIÊN
SELECT * from nhan_vien
join chuc_vu
on chuc_vu.ma = nhan_vien.chuc_vu
...
phong_ban = case when @phong_ban=-1 then phong_ban else @phong_ban end
EXEC xem_nhan_vien
end
...
--------------------------------------------------------------------------------XEM NHANH PHÒNG BAN VÀ CHỨC VỤ
CREATE proc xem_phong_ban_va_chuc_vu
AS
BEGIN
...
INSERT INTO luong_co_ban (ma_phong_ban,ma_chuc_vu,luong_co_ban)
VALUES
('1','1','15000000'),
('2','1','10000000'),
('3','1','10000000'),
